...
namespace SnowflakeIdGen
{
	public class SnowflakeGenerator
	{
		private static long Epoch = 1288834974657L; // Twitter's epoch (2010-01-01 00:00:00)
													//private static long Epoch = new DateTimeOffset(new DateTime(2000, 1, 1)).ToUnixTimeMilliseconds();
		...
		{
			return Base62Converter.ToBase62(GenerateIdNumber());
		}
		...
		{
			return DateTimeOffset.UtcNow.AddYears(44).ToUnixTimeMilliseconds();
		}
